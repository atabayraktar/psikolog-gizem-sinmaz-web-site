...
const options = [
  {
    ...
    features: [
      "Klinik ortamda gerçek temas",
      "Fiziksel güven ve mahremiytet",
      "Beden dili gözlemi",
    ],
    highlight: false,
  },
  {
    ...
    features: [
      "Evinizden konfor",
      "Şehir fark etmeksizin",
      "HIPAA uyumlu platform",
    ],
    highlight: true,
  },
];
      ...
      <div className={`container ${styles.inner}`}>
        ...
        <div className={styles.cards}>
          {options.map((o) => (
            <div
              key={o.type}
              className={`${styles.card} ${o.highlight ? styles.highlighted : ""}`}
            >
