...
import styles from "../styles/components/FloatingActions.module.scss";
    ...
    <>
      ...
      <div className={styles.right}>
        ...
        <a
          ...
          aria-label="Ön Görüşme Formu"
        >
          <FormIcon />
          <span className={styles.ctaLabel}>Ön Görüşme Formu</span>
        </a>
      </div>
