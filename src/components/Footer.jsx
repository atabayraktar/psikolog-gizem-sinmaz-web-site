      ...
      <div className={styles.inner}>
        ...
        <div className={styles.main}>
          ...
          <div className={styles.brand}>
            <span className={styles.brandName}>Psk. Gizem Sınmaz</span>
          </div>
          ...
          <div className={styles.right}>
            <div className={styles.contacts}>
              ...
              <div className={styles.contactRow}>
                <a href="tel:+905001234567" className={styles.contactItem}>
                ...
                <a href="mailto:gizem@example.com" className={styles.contactItem}>
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
            ...
            <div className={styles.socials}>
              ...
              <a href="https://wa.me/905001234567" className={styles.social} aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
        ...
        <div className={styles.bottom}>
          <p className={styles.copyright}>
            © {new Date().getFullYear()} Psikolog Gizem Sınmaz. Tüm hakları saklıdır.
          </p>
        </div>
