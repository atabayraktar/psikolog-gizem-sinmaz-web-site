      ...
      <div className={styles.inner}>
          ...
          <div className={styles.right}>
            <div className={styles.contacts}>
              ...
              <div className={styles.contactRow}>
                <a href="tel:+905015831121" className={styles.contactItem}>
                ...
                <a href="mailto:sinmazgizem@gmail.com" className={styles.contactItem}>
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
              ...
              <a
                ...
                aria-label="Konumu Google Maps'te görüntüle"
              >
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
                  <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z" strokeLinecap="round" strokeLinejoin="round"/>
                  <circle cx="12" cy="10" r="3"/>
                </svg>
                Barbaros Mah, Prof. Dr. Ümit Serdaroğlu Cad, Petek Platin İş Merkezi, No:219, D:10, Çanakkale/Merkez
              </a>
            </div>

            <div className={styles.socials}>
              <a href="https://www.instagram.com/psikologizemsinmaz" className={styles.social} aria-label="Instagram" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://wa.me/905015831121" className={styles.social} aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
        ...
        <div className={styles.bottom}>
          <p className={styles.copyright}>
            © 2026 Klinik Psikolog Gizem Sınmaz. Tüm hakları saklıdır.
          </p>
        </div>
